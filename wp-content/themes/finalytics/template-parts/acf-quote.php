<?php
/**
 * Template part for displaying Quote section (ACF Flexible content)
 *
  ...
  <div class="container-fluid">
    ...
    <cite class="quote_author">
      <div class="quote_photo">
        <?php
        $quote_author_photo = get_sub_field('quote_author_photo');
      ...
      <div class="quote_author-info">
        <span
            class="quote_author-name"><?php if (get_sub_field("quote_author_name")) echo get_sub_field("quote_author_name"); ?></span>
        <span
            class="quote_author-position"><?php if (get_sub_field("quote_author_position")) echo get_sub_field("quote_author_position"); ?></span>
      </div>
    </cite>
  </div>
