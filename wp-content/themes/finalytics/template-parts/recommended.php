<?php
/**
 * Template part for displaying Recommended section
 *
...
<?php $recommended_custom_id = get_field("recommended_custom_id"); ?>

<section <?php if (!empty($recommended_custom_id)): ?>id="<?php echo $recommended_custom_id; ?>"<?php endif; ?>
         class="recommended <?php if (get_field('recommended_color_scheme') == 'white'): ?>scheme_white<?php
         elseif (get_field('recommended_color_scheme') == 'light_blue'): ?>scheme_light-blue<?php endif; ?>">
  <div class="container-xl">
    <div class="recommended-holder">
      <?php if (!empty(get_field("recommended_title"))): ?>
        <h2 class="h2 recommended-title"><?php echo get_field("recommended_title"); ?></h2>
      <?php endif; ?>
      <div class="recommended-posts">
        <div class="recommended-posts_main">
          <?php $recommended_main_post = get_field('recommended_main_post');
        ...
        <div class="recommended-posts_secondary-list">
          <?php $recommended_secondary_posts = get_field('recommended_secondary_posts');
