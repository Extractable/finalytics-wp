<?php
/**
 * Template part for displaying Media section (ACF Flexible content)
 *
...
if (get_sub_field("media_hide_overflow")): ?>overflow-hidden<?php endif; ?>">
  ...
  <div class="container">
    <div class="media_content">
      <h2 class="h2 media_image-title"><?php if (get_sub_field("media_title")) echo get_sub_field("media_title"); ?></h2>
    ...
    <div class="media_holder">
      <?php if (get_sub_field('media_image_or_video') == 'video'): ?>
        <div class="embed-container">
          <?php if (get_sub_field("media_video")) echo get_sub_field("media_video"); ?>
        </div>
      <?php else:
