...
<section <?php if (!empty($promo_callout_custom_id)): ?>id="<?php echo $promo_callout_custom_id; ?>"<?php endif; ?>
         ...
         endif; ?> <?php if (get_sub_field('promo_callout_image_position') == 'right'): ?>image-right<?php else: ?>image-left<?php endif; ?> <?php
         if (get_sub_field("promo_callout_hide_overflow")): ?>overflow-hidden<?php endif; ?> <?php
         if (get_sub_field('promo_callout_hide_background_images')) : ?>hide_bg<?php endif; ?>">
