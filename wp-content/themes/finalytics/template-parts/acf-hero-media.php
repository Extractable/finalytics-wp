...
<section <?php if (!empty($hero_media_custom_id)): ?>id="<?php echo $hero_media_custom_id; ?>"<?php endif; ?>
         class="hero-media <?php if( get_sub_field('hero_media_color_scheme') == 'light' ): ?>scheme-light<?php else: ?>scheme-dark<?php endif; ?> <?php
         if (get_sub_field("hero_media_hide_overflow")): ?>overflow-hidden<?php endif; ?> <?php
         if (get_sub_field('hero_media_background_image') == 'waves'): ?>bg-waves<?php
