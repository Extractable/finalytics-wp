<?php
/**
 * Template part for displaying Promo callout section
 *
...
<?php $promo_callout_custom_id = get_field("promo_callout_custom_id"); ?>
<section <?php if (!empty($promo_callout_custom_id)): ?>id="<?php echo $promo_callout_custom_id; ?>"<?php endif; ?>
         class="promo-callout <?php if (get_field('promo_callout_color_scheme') == 'white'): ?>scheme_white<?php
         ...
         if (get_field("promo_callout_hide_overflow")): ?>overflow-hidden<?php endif; ?> <?php
         if (get_field('promo_callout_hide_background_images')) : ?>hide_bg<?php endif; ?>">
      ...
      <div class="row">
        <div class="col-md-6 col-lg-8">
          <div class="promo-callout_image">
            <?php
            $promo_callout_image = get_field('promo_callout_image');
          ...
          <div class="promo-callout_content-wrapper">
            <div class="promo-callout_content">
              <h3 class="h3-secondary promo-callout_title">
                <?php if (get_field("promo_callout_title")) echo get_field("promo_callout_title"); ?>
              </h3>
              <p class="promo-callout_text"><?php if (get_field("promo_callout_text")) echo get_field("promo_callout_text"); ?></p>
              <div class="promo-callout_cta">
                <?php
                $promo_callout_button_1 = get_field('promo_callout_button_1');
                if( $promo_callout_button_1 ):
                  ...
                  if (get_field('promo_callout_color_scheme') == 'light_blue'): ?>btn-link__blue<?php
                  elseif (get_field('promo_callout_color_scheme') == 'white'): ?>btn-link__blue<?php
                  elseif (get_field('promo_callout_color_scheme') == 'light_gray'): ?>btn-link__blue
                    <?php endif; ?>"
                ...
                <?php endif; ?>
                <?php
                $promo_callout_button_2 = get_field('promo_callout_button_2');
