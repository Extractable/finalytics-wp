...
<section <?php if (!empty($rich_text_custom_id)): ?>id="<?php echo $rich_text_custom_id; ?>"<?php endif; ?>
         class="rich-text <?php if (get_sub_field('rich_text_color_scheme') == 'light_gray'): ?>scheme_light-gray<?php
         elseif (get_sub_field('rich_text_color_scheme') == 'white'): ?>scheme_white<?php endif; ?>">
