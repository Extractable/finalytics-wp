...
get_header();
?>
<?php $page_custom_id = get_field("page_custom_id"); ?>
<div <?php if (!empty($query_posts_custom_id)): ?>id="<?php echo $query_posts_custom_id; ?>"<?php endif; ?>
     class="content-area page-single <?php
     if (get_field('page_color_scheme') == 'light_gray'): ?>scheme_light-gray<?php
     elseif (get_field('page_color_scheme') == 'white'): ?>scheme_white<?php
     elseif (get_field('page_color_scheme') == 'light_blue'): ?>scheme_light-blue<?php endif; ?>">
