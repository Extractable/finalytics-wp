  ...
  var Field = acf.models.ImageField.extend({
    ...
    validateAttachment: function (attachment) {
      ...
      attachment = acf.parseArgs(attachment, {
        ...
        icon: '/wp-includes/img/media/default.png'
      }); // return
...
(function ($, undefined) {
  ...
  var MediaPopup = acf.Model.extend({
    ...
    addFrameEvents: function (frame, options) {
      ...
      // src: media-views.js:2410 editImageContent()
      ...
      frame.on('select', function () {
        // vars
        var selection = frame.state().get('selection'); // if selecting img
  ...
  acf.models.SelectMediaPopup = MediaPopup.extend({
    ...
    customizeFilters: function (toolbar) {
      ...
      if (this.get('type') == 'image') {
        // update all
        filters.filters.all.text = acf.__('All img'); // remove some filters

        delete filters.filters.audio;
        delete filters.filters.video;
        delete filters.filters.image; // update all filters to show img
    ...
    customizeAttachmentLibrary: function () {
      ...
      wp.media.view.Attachment.Library = AttachmentLibrary.extend({
        ...
        toggleSelection: function (options) {
          // vars
          // src: wp-includes/js/media-views.js:2880
