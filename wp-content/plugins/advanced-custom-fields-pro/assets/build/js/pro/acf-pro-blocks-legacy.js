 ...
 *
 * This src code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this src tree.
 */
...
var ReactElement = function (type, key, ref, self, source, owner, props) {
...

  {
    ...
    Object.defineProperty(element._store, 'validated', {
      ...
      writable: true,
      value: false
    }); // self and src are DEV only properties.
...
function cloneElement(element, config, children) {
  ...
  // transpiler, and the original src is probably a better indicator of the
  // true owner.
