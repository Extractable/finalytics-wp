...
( function ( $, undefined ) {
	...
	AbstractSelect2 = clazz( Object, {
		...
		init: function ( opts ) {
			...
			if ( $.isFunction( this.opts.initSelection ) ) {
				// initialize selection based on the current value of the src element
				this.initSelection();

				// if the user has provided a function that can set selection based on the value of the src element
		...
		/**
		 * Triggers the change event on the src element
		 */
		// abstract
	...
	SingleSelect2 = clazz( AbstractSelect2, {
		...
		/**
		 * Sets selection based on src element's value
		 */
		// single
