...
function wptools_options_permissions()
{
	...
	if (file_exists(ABSPATH . 'wp-config.php'))
		echo esc_attr_e("wp-config.php currently permissions:","wptools") . decoct(fileperms(ABSPATH . 'wp-config.php') & 0777);
	echo '<br>';
	echo '<br>';
	echo '<br>';
