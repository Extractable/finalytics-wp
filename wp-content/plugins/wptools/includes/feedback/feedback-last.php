                ...
                if(function_exists('wptools_check_memory')) {
                    ...
                    try {
                       ...
                       if(gettype($wptools_memory) == 'array' and isset($wptools_memory['percent'])) {
                            ...
                            if($wptools_memory['percent'] > 0.70) {
                                ...
                                echo 'Your current memory usage now is too high: '.round(($wptools_memory['percent'] * 100)).'%';
                 ...
                 <br /><br /> 			
                       <img src="/wp-admin/images/wpspin_light-2x.gif" id="imagewaitfbl" style="display:none" />
                        <a href="https://BillMinozzi.com/dove/" class="button button-primary <?php echo PRODCLASS;?>-close-dialog"><?php  esc_attr_e("Support Page","wptools");?></a>
