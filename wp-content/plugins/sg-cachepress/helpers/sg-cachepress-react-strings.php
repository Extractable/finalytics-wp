...
$optimizer_i18n_strings = array(
	...
	__( 'Image optimization is one of the fundamentals of improving site speed. With image compression, lazy load, and WebP enabled, your site loading speed will be reduced significantly. Additionally, the space your img occupy may also decrease, optimizing your disk space usage.', 'sg-cachepress' ),
	...
	__( 'Back up all original img.', 'sg-cachepress' ),
	...
	__( 'I want to compress my existing img, too.', 'sg-cachepress' ),
	__( 'Overwrite img with custom compression level', 'sg-cachepress' ),
	__( 'Changing your compression level will re-generate all existing img. This is a time and resource consuming process that may take awhile, depending on the number and size of your img.', 'sg-cachepress' ),
	__( 'Compressing image %(converted)s of %(total)s...', 'sg-cachepress' ),
	__( 'Image Compression', 'sg-cachepress' ),
	__( 'We will resize your img to decrease the space they occupy and the time needed for each image to load. The dimensions of your img will not change and with our improved resizing algorithm the visual change in quality is practically non-detectable. Changing your compression level will re-generate all existing img, including WebP img. This is a time and resource consuming process that may take awhile depending on the number and size of your img.', 'sg-cachepress' ),
	...
	__( 'If you’re often uploading or using large img on your website, you might want to start resizing img to fit a maximum width. This can reduce the img size up to 80% and dramatically increase loading speed on pages with one or more large img. Enabling this will resize your existing and future img whose width exceeds 2560 px.', 'sg-cachepress' ),
	...
	__( 'Deactivating the use of WebP img will delete all currently generated WebP files. We will regenerate them again if you enable the option.', 'sg-cachepress' ),
	__( 'Enabling WebP will re-generate all existing WebP img, if any and will generate new WebP versions of all existing standard img. This is a time and resource consuming process that may take awhile, depending on the number and size of your img.', 'sg-cachepress' ),
